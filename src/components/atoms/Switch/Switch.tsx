...
export const Switch: React.FC<Props> = (props: Props) => {
  ...
  return (
    ...
    >
      {controls ? <input type="checkbox" ref={checkboxRef} id={id} checked={checked} aria-controls={controls} className="visually-hidden" onChange={onChange} /> : <input type="checkbox" ref={checkboxRef} id={id} checked={checked} tabIndex={-1} className="visually-hidden" onChange={onChange} />}
